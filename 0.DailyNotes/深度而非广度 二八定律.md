...
```mermaid
flowchart LR
    title["80/20方案流程——豪华车维护成本高的应对策略"]:::title
    problem{{"问题：豪华车维护成本高"}}:::problem
    solution1{"自行维护"}:::decision
    buyOldCar(["购买老款豪华车<br>（如Land Rover Discovery 3）"]):::key
    subgraph 日常使用["日常/长期用车"]
        dd(["通勤：廉价电动车"]):::daily
    end
    subgraph 假期体验["假期/周末用车"]
        week(["豪华越野体验"]):::highlight
    end
    skills(["维护技能提升<br>社区知识+实践"]):::skills

    problem --> solution1 --> buyOldCar
    buyOldCar --> dd
    buyOldCar --> week
    buyOldCar --> skills

    %% 风格定义
    classDef title font-size:24px,fill:#EEF2F7,stroke:#8BA9C8,stroke-width:2px;
    classDef problem fill:#F8D7DA,stroke:#C82333,stroke-width:2px,font-weight:bold;
    classDef decision fill:#FFF3CD,stroke:#FFA000,stroke-width:2px;
    classDef key fill:#D1E7DD,stroke:#0F5132,stroke-width:2px,font-weight:bold;
    classDef daily fill:#E0E7FF,stroke:#2563EB,stroke-width:1.5px;
    classDef highlight fill:#FDE68A,stroke:#CA8A04,stroke-width:1.5px;
    classDef skills fill:#D1C4E9,stroke:#512DA8,stroke-width:2px,font-style:italic;

    %% 高亮级别
    class problem,title,solution1,key daily,highlight,skills;
```
[Mermaid Chart - Create complex, visual diagrams with text.](https://www.mermaidchart.com/app/projects/11f686a1-a8a4-4a90-af63-6d273a2acf67/diagrams/8a46bd6c-a639-4157-9ef4-8ff6ab4be4b4/version/v0.1/edit)
...
graph TD
    ...
    classDef coreNode fill:#FFB703,stroke:#333,stroke-width:3px,font-weight:bold,color:#000
